...
df=pd.read_csv("Mytraining.csv")
DF= pd.read_csv('Mytraining.csv', index_col='prognosis')
...
lrLb = Label(root, text="Disease prediction", fg="white", bg="red", width = 20)
